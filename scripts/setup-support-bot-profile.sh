...
banner "StaffPlusPRO SupportBot profil rasmi"

stage "BotFather: profil rasmini o'rnatish"
say "Telegram Bot API bot profil rasmini dasturiy yangilashga ruxsat bermaydi."
say "About, qisqa tavsif va buyruqlar deploy vaqtida backend tomonidan avtomatik yangilanadi."
